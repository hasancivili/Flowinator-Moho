...
function FlowinatorDialog:new(moho)
	...
	l:PushV(LM.GUI.ALIGN_TOP)
	d.typeTitle = add_dynamic(l, "TYPE", 155)
	l:PushH()
	d.assetsModeButton = add_button(l, "Assets", MSG_MODE_ASSETS)
	d.shotsModeButton = add_button(l, "Shots", MSG_MODE_SHOTS)
	l:Pop()
	d.modeStatus = add_dynamic(l, "Mode: Assets", 155)
	d.typeList = LM.GUI.TextList(155, 300, MSG_TYPE_SELECTED)
	...
	l:PushV(LM.GUI.ALIGN_TOP)
	d.variantTitle = add_dynamic(l, "VARIANT", 155)
	l:PushH()
	add_small_button(l, "Add", MSG_ADD_VARIANT)
	add_small_button(l, "Delete", MSG_DELETE_VARIANT)
	l:Pop()
	d.variantList = LM.GUI.TextList(155, 300, MSG_VARIANT_SELECTED)
	...
	l:Pop()
	d.workTypeList = LM.GUI.TextList(155, 300, MSG_WORK_TYPE_SELECTED)
	...
	l:Pop()
	d.workItemList = LM.GUI.TextList(155, 300, MSG_WORK_ITEM_SELECTED)
	...
	d.workVersionHeader = add_dynamic(l, "Version          Author                  Commit", 420)
	d.workVersionList = LM.GUI.TextList(420, 95, MSG_WORK_VERSION_SELECTED)
	...
	d.publishVersionHeader = add_dynamic(l, "Version          Author                  Commit                                      Live", 500)
	d.publishVersionList = LM.GUI.TextList(420, 75, MSG_PUBLISH_VERSION_SELECTED)
